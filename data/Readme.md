...
Si bien el procesamiento realizado permitió detectar varias patentes
correctamente, también aparecieron errores de OCR, imágenes borrosas,
detecciones incompletas y textos que no correspondían a una patente.

El uso de técnicas de procesamiento de imágenes como escala de grises,
suavizado y detección de bordes ayudó a mejorar parcialmente la calidad
de las detecciones. Aun así, los resultados muestran que trabajar con
imágenes reales implica lidiar con ruido, diferencias de iluminación y
problemas de calidad visual.

Por otro lado, la comparación entre las patentes detectadas y el dataset
de multas permitió relacionar varias imágenes con registros reales,
utilizando una lógica de similitud para tolerar pequeños errores de OCR.
Esto demuestra cómo la visión por computadora y el análisis de datos
pueden complementarse para validar información automáticamente.
